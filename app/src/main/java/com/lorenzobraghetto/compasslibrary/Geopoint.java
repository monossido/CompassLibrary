...
public final class Geopoint implements ICoordinates, Parcelable {
	...
	/*
	 * Return a waypoint which is the copy of this one rounded to the given
	 * limit. For example, to get a waypoint adapter to a display with 3 digits
	 * after the seconds decimal point, a rounding factor of 3600*1000 would be
	 * appropriate.
	 */
	 ...
	 * @param target
	 *            The target
	 * @return An array of floats: the distance in meters, then the bearing in
	 *         degrees
	 */
	...
	/**
	 * Returns formatted coordinates with default format. Default format is
	 * decimalminutes, e.g. N 52° 36.123 E 010° 03.456
	 * 
	 * @return formatted coordinates
	 */
	@Override
	...
	/**
	 * Check whether a latitude built from user supplied data is valid. We
	 * accept both N90/S90.
	 * 
	 * @return <tt>true</tt> if the latitude looks valid, <tt>false</tt>
	 *         otherwise
	 */
	...
	/**
	 * Check whether a longitude from user supplied data is valid. We accept
	 * both E180/W180.
	 * 
	 * @return <tt>true</tt> if the longitude looks valid, <tt>false</tt>
	 *         otherwise
	 */
	...
	/**
	 * Check whether a geopoint built from user supplied data is valid. We
	 * accept both N90/S90 and E180/W180.
	 * 
	 * @return <tt>true</tt> if the geopoint looks valid, <tt>false</tt>
	 *         otherwise
	 */
