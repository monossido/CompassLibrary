...
/**
 * Derivated class of {@link android.os.HandlerThread} with an exposed handler
 * and a start/stop mechanism based on subscriptions.
 */
...
public class StartableHandlerThread extends HandlerThread {
	...
	public StartableHandlerThread(final String name, final int priority, final Callback callback) {
		super(name, priority);
		this.callback = callback;
	}

	public StartableHandlerThread(final String name, final int priority) {
