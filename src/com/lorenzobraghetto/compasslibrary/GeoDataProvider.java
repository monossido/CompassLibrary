...
public class GeoDataProvider implements OnSubscribe<IGeoData> {
	 ...
	 * <p/>
	 * There is no need to instantiate more than one such object in an
	 * application, as observers can be added at will.
	 * 
	 * @param context
	 *            the context used to retrieve the system services
	 */
	...
	private IGeoData findInitialLocation() {
		...
		try {
			...
			Log.e("GeoDataProvider: error when retrieving last known location", e.toString());
		}
